...
export default function AsteroidFilter({
  setFilter,
  setOpenFilter,
  openFilter,
  filter,
  ...
  return (
    <div
      className={`text-white flex justify-between px-1 gap-3 mb-3  text-xl  items-center mt-3 max-w-4xl mx-auto `}
    >
      <Select
        unstyled
        placeholder="Show All Asteroid"
        options={filterOptions}
        onChange={(selectedOption: any) =>
          setFilter((prev: any) => ({ ...prev, danger: selectedOption?.value }))
        }
